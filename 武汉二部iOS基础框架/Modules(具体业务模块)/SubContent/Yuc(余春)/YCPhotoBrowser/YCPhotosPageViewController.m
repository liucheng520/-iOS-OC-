...
- (void)pageViewController:(UIPageViewController *)pageViewController didFinishAnimating:(BOOL)finished previousViewControllers:(NSArray *)previousViewControllers transitionCompleted:(BOOL)completed {
    ...
    if (completed)
    {
        ...
        if([self.delegate respondsToSelector:@selector(PhotosPageViewControlller:didChangedBackIndex:)])
        {
            [self.delegate PhotosPageViewControlller:self didChangedBackIndex:self.currentIndex];
        }
        
        if([self.delegate respondsToSelector:@selector(PhotosPageViewControlller:didChangedBackIndexPath:)])
        {
            [self.delegate PhotosPageViewControlller:self didChangedBackIndexPath:[_currentViewController photo].indexPath];
        }
