...
- (void)animatateZoomInTransition
{
    ...
    [UIView animateWithDuration:[self transitionDuration:_transitionContext] delay:0 usingSpringWithDamping:0.8 initialSpringVelocity:0 options:(UIViewAnimationOptionCurveEaseIn) animations:^{
