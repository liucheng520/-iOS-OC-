...
//        _tableView.rowHeight = UITableViewAutomaticDimension;
        ...
        {
            [_tableView setSeparatorInset:UIEdgeInsetsMake(0, CELL_LINE_LEFT_DISTANCE, 0, CELL_LINE_RIGHT_DISTANCE)];
        }
        
        if ([_tableView respondsToSelector:@selector(setLayoutMargins:)])
        {
            [_tableView setLayoutMargins:UIEdgeInsetsMake(0, CELL_LINE_LEFT_DISTANCE, 0, CELL_LINE_RIGHT_DISTANCE)];
        }
    }
    return _tableView;
}
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        [cell setSeparatorInset:UIEdgeInsetsMake(0, CELL_LINE_LEFT_DISTANCE, 0, CELL_LINE_RIGHT_DISTANCE)];
    }
    if ([cell respondsToSelector:@selector(setLayoutMargins:)])
    {
        [cell setLayoutMargins:UIEdgeInsetsMake(0, CELL_LINE_LEFT_DISTANCE, 0, CELL_LINE_RIGHT_DISTANCE)];
    }
}
